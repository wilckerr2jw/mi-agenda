...
const VERSION = 'agenda-v4.3';
const CDN = 'agenda-cdn';
const SHELL = [
  './', 'index.html', 'guia.html', 'manifest.webmanifest',
  'css/styles.css',
  'js/agenda.js', 'js/app.js', 'js/config.js', 'js/guide.js', 'js/tour.js', 'js/junta.js', 'js/keep.js', 'js/lock.js', 'js/notify.js', 'js/reports.js', 'js/model.js', 'js/sheets.js', 'js/store.js', 'js/theme.js', 'js/util.js', 'js/views.js', 'js/weekimg.js',
